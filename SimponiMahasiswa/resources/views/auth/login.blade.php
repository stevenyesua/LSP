        ...
        <div class="box-formulir bg-white w-96 p-8">
            ...
            @csrf
                <div class="relative mt-4">
                    <input name="email" type="email" id="email" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="relative mt-4 text-xs flex">
                    <p class="">Jika belum memiliki akun silahkan
                        <a href="/user/register" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
                       daftar disini.
                        </a>
                    </p>
                </div>
