...
<div class="bg-white mx-96 p-8 text-xl  gap-8">
    ...
    @csrf
        <div class="relative mt-4">
            <input name="judul" type="text" id="judul" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <div class="">
            <h2 class="text-xs mt-2">Judul maksimal 20 karakter.</h2>
        </div>
        <div class="relative mt-4">
